...
/* 
elem_ptr 待转换的地址，结构体中某个成员的地址
struct_type elem_ptr所属结构体的类型
member\struct_member_name 字符串，elem_ptr对应地址的成员名字
宏offset 获取结构体成员member在结构体中的偏移量
宏elem2entry 根据结构体成员struct_member_name获取结构体
*/
